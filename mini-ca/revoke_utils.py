...
def create_empty_crl(issuer_cert, issuer_key):
    crl_builder = x509.CertificateRevocationListBuilder().issuer_name(issuer_cert.subject)
...
def revoke_certificate(cert_file: str, issuer_cert_file: str, issuer_key_file: str, 
