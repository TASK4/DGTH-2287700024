...
def revoke_demo():
    ...
    revoke_certificate(
        os.path.join("certs", "Hieu_Do_cert.pem"),
        os.path.join("certs", "intermediate_cert.pem"),
...
def ocsp_check_demo():
    print("Kiểm tra trạng thái OCSP của Hieu_Do_cert.pem...")
    status = check_revocation_status(os.path.join("certs", "Hieu_Do_cert.pem"))
